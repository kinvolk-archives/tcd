...
type TcdServiceClient interface {
	...
	TestingMethod(ctx context.Context, in *InstallRequest, opts ...grpc.CallOption) (*InstallResponse, error)
...
func (c *tcdServiceClient) TestingMethod(ctx context.Context, in *InstallRequest, opts ...grpc.CallOption) (*InstallResponse, error) {
	out := new(InstallResponse)
	err := grpc.Invoke(ctx, "/tcdapi.TcdService/TestingMethod", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TcdServiceServer interface {
	...
	TestingMethod(context.Context, *InstallRequest) (*InstallResponse, error)
...
func _TcdService_TestingMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InstallRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TcdServiceServer).TestingMethod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tcdapi.TcdService/TestingMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TcdServiceServer).TestingMethod(ctx, req.(*InstallRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _TcdService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TcdService_TestingMethod_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	0xcc, 0x25, 0x88, 0x64, 0x1f, 0xc4, 0x11, 0x46, 0x5b, 0x99, 0xb8, 0xb8, 0x42, 0x92, 0x53, 0x82,
	0x21, 0x9e, 0x14, 0x72, 0xe2, 0xe2, 0x85, 0x3a, 0xd3, 0x37, 0xb5, 0x24, 0x23, 0x3f, 0x45, 0x48,
	0x4c, 0x0f, 0xe2, 0x61, 0x3d, 0x54, 0xdf, 0x4a, 0x89, 0x63, 0x88, 0x43, 0x7d, 0xc5, 0x00, 0x32,
	0x23, 0x04, 0xa8, 0x24, 0x33, 0x2f, 0x9d, 0x7c, 0x33, 0xfc, 0xb9, 0xc4, 0xe0, 0x6e, 0xf5, 0xcc,
	0x4b, 0x2f, 0x4a, 0x2d, 0x2e, 0x86, 0x1a, 0x26, 0x01, 0xd3, 0x84, 0x1e, 0x76, 0x52, 0x92, 0x58,
	0x64, 0xe0, 0x06, 0xfa, 0x71, 0x89, 0xc2, 0x85, 0x5d, 0x29, 0x37, 0x2f, 0x89, 0x0d, 0x9c, 0x1c,
	0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x2c, 0x36, 0x3f, 0x43, 0x1f, 0x02, 0x00, 0x00,
}
