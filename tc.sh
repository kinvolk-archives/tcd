...
tc qdisc add dev eth0 handle 2:0 parent 1:1 netem delay 0ms loss 0%

tc class add dev eth0 parent 1:0 classid 1:2 htb rate 80000bps
tc qdisc add dev eth0 handle 3:0 parent 1:2 netem delay 0ms loss 0% rate 10kbit

tc class add dev eth0 parent 1:0 classid 1:3 htb rate 80000bps
tc qdisc add dev eth0 handle 4:0 parent 1:3 netem delay 0ms loss 0% rate 1000kbit
